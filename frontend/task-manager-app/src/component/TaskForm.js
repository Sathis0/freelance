...
const TaskForm = forwardRef( ({reRendertasks},ref)=>{
    ...
    const sendData = async ()=>{
        ...
        const task = {
            assigne_name:assigne_name.current.value,
        ...
        <div id="form_container" ref={ref} onClick={e=>{
            ...
            <i className="fa-solid fa-xmark"></i>
                ...
                <div className="input_con">
                    ...
                    <input type="text" placeholder="Assigne name" id="task_name_input" ref={assigne_name}/>
                </div>
                <div className="input_con">
                    <span>Task name</span>
                ...
                <select id="category_select" className="fa" ref={taskCategoryInput} >
                    ...
                    <option className="fa" value="Task"> &nbsp; Task</option>
